...
app.modalConstants.family[156] = "CREATURE_FAMILY_SE_DETERRE_AU_CONTACT - 0.5 0.9 0.5(1.5) : 1/3_Mouvement_Contact_Basique, 1/3_Mouvement_Contact_Tournant_Aleatoire, 1/3_Mouvement_Contact_Avance_Recule   ->>> SI PICKPOCKETLOOT <<<- Sans fumee : UPDATE `creature_template_addon` SET `auras` = '58984 164339' WHERE `creature_template_addon`.`entry` = xxxx;) ";
