...
(function () {
  ...
  app.modalConstants.family[1]  = "Loup  -  CREATURE_FAMILY_WOLF - (0.6 1.3 0.7) : 1/3_Mouvement_Contact_Basique , 2/3_Mouvement_Contact_Prudent";
  app.modalConstants.family[2]  = "Felin  -  CREATURE_FAMILY_CAT - (0.6 1.3 0.7) : Mouvement_Contact_Tournant_Aleatoire (invisible)";
  ...
  app.modalConstants.family[4]  = "Ours  -  CREATURE_FAMILY_BEAR - (0.6 1.3 0.6) : Mouvement_Contact_Basique, Instincts_de_survie (charge)";
  app.modalConstants.family[5]  = "Sanglier  -  CREATURE_FAMILY_BOAR - (0.6 1.3 0.7) : Mouvement_Contact_Charges_Multiples";
  app.modalConstants.family[6]  = "Crocodile  -  CREATURE_FAMILY_CROCOLISK - (0.4 0.8 1.5) : 1/3_Mouvement_Contact_Avance_Recule , 2/3_Mouvement_Contact_Basique, (Ecorce)";
  ...
  app.modalConstants.family[8]  = "Crabe  -  CREATURE_FAMILY_CRAB - (0.4 0.8 1.5) : Mouvement_Contact_Avance_Recule - 1/2 Mouvement_Contact_Basique";
  app.modalConstants.family[9]  = "Gorille  -  CREATURE_FAMILY_GORILLA - (0.6 1.3 0.5) : Mouvement_Contact_Bondissant, (Bondir_Guerrier)";
  app.modalConstants.family[10] = "Custom  -  CREATURE_FAMILY_HORSE_CUSTOM - (0.5 1.0 0.6) : ";
  app.modalConstants.family[11] = "Raptor  -  CREATURE_FAMILY_RAPTOR - (0.6 1.3 0.7) : 1/4_Mouvement_Contact_Avance_Recule  , 1/4_Mouvement_Contact_Tournant_Aleatoire, 2/4_Mouvement_Contact_Basique, (Cri_Incapacitant)";
  app.modalConstants.family[12] = "Grand trotteur  -  CREATURE_FAMILY_TALLSTRIDER - (0.5 1.0 0.7) : 1/2 Mouvement_Contact_Avance_Recule , 1/2 Mouvement_Contact_Basique";
  ...
  app.modalConstants.family[23] = "Imp  -  CREATURE_FAMILY_IMP - (0.5 1.0 0.6) : Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance )";
  ...
  app.modalConstants.family[27] = "Serpent des vents  -  CREATURE_FAMILY_WIND_SERPENT - (0.75 1.0 0.5) : Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance, (Bouclier_De_Foudre) )";
  ...
  app.modalConstants.family[31] = "Ravageur  -  CREATURE_FAMILY_RAVAGER - (0.6 1.3 0.7) : 1/4_Mouvement_Contact_Prudent , 1/4_Mouvement_Contact_Avance_Recule , 1/4_Mouvement_Contact_Tournant_Aleatoire , 1/4_Mouvement_Contact_Charges_Multiples, (Poursuite, Griffure_bondissante) ";
  ...
  app.modalConstants.family[34] = "Raie du Neant  -  CREATURE_FAMILY_NETHER_RAY - (0.75 1.0 0.5): 1/2_Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance ) , 1/2_Mouvement_Caster";
  ...
  app.modalConstants.family[42] = "Ver  -  CREATURE_FAMILY_WORM - (0.4 1.0 0.6) : Mouvement_Caster_Puis_Contact ( spell [2]=spell a distance  - (UPDATE `creature_template_addon` SET `auras` = '58984 164339' WHERE `creature_template_addon`.`entry` = 8603)";
  app.modalConstants.family[43] = "Rhinoceros/Kodo  -  CREATURE_FAMILY_RHINO (0.6 1.3 0.6) - AI : 1/3_Mouvement_Contact_Basique , 2/3_Mouvement_Contact_Charges_Multiples, %Charge_Repousse";
  app.modalConstants.family[44] = "Guepe  -  CREATURE_FAMILY_WASP - (0.75 1.0 0.5): Mouvement_Contact_Prudent_Volant";
  ...
  app.modalConstants.family[49] = "Elementaire d'eau  -  CREATURE_FAMILY_WATER_ELEMENTAL - (0.8 1.0 1.5) : 1/3_Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance RAPIDE) , 1/3_Mouvement_Caster , 1/3_Mouvement_Contact_Basique";
  app.modalConstants.family[50] = "Renard  -  CREATURE_FAMILY_FOX - (0.5 1.0 0.6) : 1/3_Mouvement_Contact_Basique , 2/3_Mouvement_Contact_Prudent";
...
app.modalConstants.family[68] = "Hydre  -  CREATURE_FAMILY_HYDRA - (0.6 1.3 2.0) :  1/2_Mouvement_Contact_Basique , 1/2_Mouvement_Contact_Avance_Recule, %Poison_Tir_Catapulte";
...
app.modalConstants.family[101] = "Seigneur du Vide  -  CREATURE_FAMILY_VOIDLORD - (0.75 1.0 0.6): ";
...
app.modalConstants.family[116] = "elementaire de feu  -  CREATURE_FAMILY_FIREELEMENTAL - (0.75 1.5 0.8) : 1/4_Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance ) , 1/4_Mouvement_Caster , 2/4_Mouvement_Contact_Basique, %Armure_De_La_Fournaise";
app.modalConstants.family[117] = "elementaire de terre  -  CREATURE_FAMILY_EARTHELEMENTAL - (0.7 1.0 0.8) : Mouvement_Contact_Basique, %Ecorce %Lancer_Une_Pierre";
app.modalConstants.family[125] = "Grue  -  CREATURE_FAMILY_CRANE  - (0.4 1.0 0.7) : ";
app.modalConstants.family[126] = "Trotteur aquatique  -  CREATURE_FAMILY_WATERSTRIDER - (0.5 1.0 0.7) : ";
...
app.modalConstants.family[130] = "Basilic  -  CREATURE_FAMILY_BASILISK - (0.4 1.0 1.5) : 1/2 Mouvement_Contact_Avance_Recule , Mouvement_Contact_Basique , %Ecorce";
app.modalConstants.family[138] = "Navrecorne  -  CREATURE_FAMILY_DIREHORN - AI : ";
app.modalConstants.family[145] = "elem. de tempete  -  CREATURE_FAMILY_STORMELEMENTAL - (0.75 1.5 0.8) : ";
app.modalConstants.family[146] = "MT - Water Elemental  -  CREATURE_FAMILY_MTWATERELEMENTAL - (0.8 1.0 1.5) : ";
