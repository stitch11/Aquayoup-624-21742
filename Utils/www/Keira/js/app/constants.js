...
(function () {
  ...
  app.modalConstants.family[1]  = "Loup  -  CREATURE_FAMILY_WOLF - 0.6 1.3 0.5(0.7) : 1/3_Mouvement_Contact_Basique , 2/3_Mouvement_Contact_Prudent";
  app.modalConstants.family[2]  = "Felin  -  CREATURE_FAMILY_CAT - 0.6 1.3 0.5(0.7) : Mouvement_Contact_Tournant_Aleatoire (invisible)";
  app.modalConstants.family[3]  = "Araignee  -  CREATURE_FAMILY_SPIDER - 0.4 1.0 0.5(0.5) : Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance Cumulable, Doit avoir du mana , Toile_Araignee)";
  app.modalConstants.family[4]  = "Ours  -  CREATURE_FAMILY_BEAR - 0.6 1.3 0.5(0.6) : Mouvement_Contact_Basique, Instincts_de_survie (charge)";
  app.modalConstants.family[5]  = "Sanglier  -  CREATURE_FAMILY_BOAR - 0.6 1.3 0.5(0.7) : Mouvement_Contact_Charges_Multiples";
  app.modalConstants.family[6]  = "Crocodile  -  CREATURE_FAMILY_CROCOLISK - 0.4 0.8 0.6(1.5) : 1/3_Mouvement_Contact_Avance_Recule , 2/3_Mouvement_Contact_Basique, (Ecorce)";
  ...
  app.modalConstants.family[8]  = "Crabe  -  CREATURE_FAMILY_CRAB - 0.4 0.8 0.4(1.5) : Mouvement_Contact_Avance_Recule - 1/2 Mouvement_Contact_Basique";
  app.modalConstants.family[9]  = "Gorille  -  CREATURE_FAMILY_GORILLA - 0.6 1.3 0.5(0.5) : Mouvement_Contact_Bondissant, (Bondir_Guerrier)";
  app.modalConstants.family[10] = "Custom  -  CREATURE_FAMILY_HORSE_CUSTOM - 0.5 1.0 0.5(0.6)";
  app.modalConstants.family[11] = "Raptor  -  CREATURE_FAMILY_RAPTOR - 0.6 1.3 0.5(0.7) : 1/4_Mouvement_Contact_Avance_Recule  , 1/4_Mouvement_Contact_Tournant_Aleatoire, 2/4_Mouvement_Contact_Basique, (Cri_Incapacitant)";
  app.modalConstants.family[12] = "Grand trotteur  -  CREATURE_FAMILY_TALLSTRIDER - 0.5 1.0 0.7(0.7) : 1/2 Mouvement_Contact_Avance_Recule , 1/2 Mouvement_Contact_Basique";
  ...
  app.modalConstants.family[17] = "Succube  -  CREATURE_FAMILY_SUCCUBUS - 0.75 1.0 0.8(0.6) : 1/2_Mouvement_Contact_Tournant_Aleatoire - 1/2_Mouvement_Contact_Basique";
  app.modalConstants.family[19] = "Garde funeste (Doomguard)  -  CREATURE_FAMILY_DOOMGUARD - 0.75 1.0 0.8(0.6): Mouvement_Contact_Charges_Multiples, (Bondir_Guerrier)";
  app.modalConstants.family[20] = "Scorpion  -  CREATURE_FAMILY_SCORPID - 0.5 1.2 0.5(0.5) : Mouvement_Contact_Avance_Recule - spell [2] Cumulable";
  app.modalConstants.family[21] = "Tortue  -  CREATURE_FAMILY_TURTLE - 0.4 0.8 0.4(1.5) : Mouvement_Contact_Basique";
  app.modalConstants.family[23] = "Imp  -  CREATURE_FAMILY_IMP - 0.5 1.0 0.5(0.6) : Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance Non cumulable )";
  ...
  app.modalConstants.family[25] = "Hyene  -  CREATURE_FAMILY_HYENA - 0.5 1.0 0.5(0.6) : Mouvement_Contact_Prudent";
  ...
  app.modalConstants.family[27] = "Serpent des vents  -  CREATURE_FAMILY_WIND_SERPENT - 1 1.25 0.8(0.5) : Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance Non cumulable )";
  ...
  app.modalConstants.family[31] = "Ravageur  -  CREATURE_FAMILY_RAVAGER - 0.6 1.3 0.5(0.7) : 1/4_Mouvement_Contact_Prudent , 1/4_Mouvement_Contact_Avance_Recule , 1/4_Mouvement_Contact_Tournant_Aleatoire , 1/4_Mouvement_Contact_Charges_Multiples, (Poursuite, Griffure_bondissante) ";
  ...
  app.modalConstants.family[34] = "Raie du Neant  -  CREATURE_FAMILY_NETHER_RAY - 0.75 1.0 0.8(0.5) : 1/2_Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance Non cumulable) , 1/2_Mouvement_Caster";
  app.modalConstants.family[35] = "Serpent  -  CREATURE_FAMILY_SERPENT - 0.4 1.0 0.5(0.5) : Mouvement_Contact_Basique";
  ...
  app.modalConstants.family[40] = "Goule  -  CREATURE_FAMILY_GHOUL - 0.4 1.0 0.5(0.5) : Mouvement_Contact_Basique (vit 0.4-1-0.5)";
  app.modalConstants.family[41] = "Silithide  -  CREATURE_FAMILY_SILITHID - 0.5 1.2 0.5 - AI 1/3_Mouvement_Contact_Basique , 1/3_Mouvement_Contact_Tournant_Aleatoire , 1/3_Mouvement_Contact_Charges_Multiples";
  app.modalConstants.family[42] = "Ver  -  CREATURE_FAMILY_WORM - 0.4 1.0 0.5 : Mouvement_Caster_Puis_Contact ( spell [2]=spell a distance Cumulable - UPDATE `creature_template_addon` SET `auras` = '58984 164339' WHERE `creature_template_addon`.`entry` = 8603)";
  app.modalConstants.family[43] = "Rhinoceros/Kodo  -  CREATURE_FAMILY_RHINO - 0.6 1.3 0.5(0.6) - AI : 1/3_Mouvement_Contact_Basique , 2/3_Mouvement_Contact_Charges_Multiples, %Charge_Repousse";
  app.modalConstants.family[44] = "Guepe  -  CREATURE_FAMILY_WASP - 0.75 1.0 0.8(0.5) : Mouvement_Contact_Prudent_Volant";
  ...
  app.modalConstants.family[49] = "Elementaire d'eau  -  CREATURE_FAMILY_WATER_ELEMENTAL - 0.8 1.0 0.7(1.5) : 1/3_Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance RAPIDE Cumulable) , 1/3_Mouvement_Caster , 1/3_Mouvement_Contact_Basique";
  app.modalConstants.family[50] = "Renard  -  CREATURE_FAMILY_FOX - 0.5 1.0 0.5(0.6) : 1/3_Mouvement_Contact_Basique , 2/3_Mouvement_Contact_Prudent";
app.modalConstants.family[51] = "Singe  -  CREATURE_FAMILY_MONKEY - 0.4 1.0 0.5(0.5) : Mouvement_Caster";
...
app.modalConstants.family[53] = "Hanneton  -  CREATURE_FAMILY_BEETLE - 0.5 1.0 0.5(0.5)";
...
app.modalConstants.family[56] = "Zombie  -  CREATURE_FAMILY_ZOMBIE - 0.4 1.0 0.5(0.5) : Mouvement_Contact_Basique";
...
app.modalConstants.family[68] = "Hydre  -  CREATURE_FAMILY_HYDRA - 0.6 1.3 0.5(2.0) :  1/2_Mouvement_Contact_Basique , 1/2_Mouvement_Contact_Avance_Recule, %Poison_Tir_Catapulte";
app.modalConstants.family[100] = "Diablotin gangrene  -  CREATURE_FAMILY_FELIMP - AI : 1/2_Mouvement_Contact_Avance_Recule , 1/2_Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance Cumulable)";
app.modalConstants.family[101] = "Seigneur du Vide  -  CREATURE_FAMILY_VOIDLORD - 0.75 1.0 0.8(0.6)";
...
app.modalConstants.family[108] = "Infernal  -  CREATURE_FAMILY_INFERNAL - 0.6 1.3 0.5(0.5) : Mouvement_Contact_Basique";
app.modalConstants.family[116] = "elementaire de feu  -  CREATURE_FAMILY_FIREELEMENTAL - 0.75 1.5 0.5(0.8) : 1/4_Mouvement_Caster_Puis_Contact ( spell [2] = spell a distance Cumulable ) , 1/4_Mouvement_Caster , 2/4_Mouvement_Contact_Basique, %Armure_De_La_Fournaise";
app.modalConstants.family[117] = "elementaire de terre  -  CREATURE_FAMILY_EARTHELEMENTAL - 0.7 1.0 0.8(0.8) : Mouvement_Contact_Basique, %Ecorce %Lancer_Une_Pierre";
app.modalConstants.family[125] = "Grue  -  CREATURE_FAMILY_CRANE  - 0.4 1.0 0.4(0.7)";
app.modalConstants.family[126] = "Trotteur aquatique  -  CREATURE_FAMILY_WATERSTRIDER - 0.5 1.0 0.7(0.7)";
app.modalConstants.family[127] = "Porc-epic  -  CREATURE_FAMILY_PORCUPINE - 0.5 1.2 0.5(0.5)";
app.modalConstants.family[128] = "Quilen  -  CREATURE_FAMILY_QUILEN - AI ";
app.modalConstants.family[129] = "Chevre  -  CREATURE_FAMILY_GOAT - 0.5 1.2 0.5(0.5) ";
app.modalConstants.family[130] = "Basilic  -  CREATURE_FAMILY_BASILISK - 0.4 1.0 0.5(1.5) : 1/2 Mouvement_Contact_Avance_Recule , Mouvement_Contact_Basique , %Ecorce";
app.modalConstants.family[138] = "Navrecorne  -  CREATURE_FAMILY_DIREHORN - AI ";
app.modalConstants.family[145] = "elem. de tempete  -  CREATURE_FAMILY_STORMELEMENTAL - 0.75 1.5 0.8(0.8)";
app.modalConstants.family[146] = "MT - Water Elemental  -  CREATURE_FAMILY_MTWATERELEMENTAL - 0.8 1.0 0.7(1.5) ";
...
app.modalConstants.family[149] = "Rylak  -  CREATURE_FAMILY_RYLAK - 0.5 1.2 0.5(0.5)";
app.modalConstants.family[150] = "Potamodonte  -  CREATURE_FAMILY_RIVERBEAST - 0.75 1.5 1.0(1.5)";
app.modalConstants.family[151] = "Cerf  -  CREATURE_FAMILY_STAG - 0.5 1.2 0.5(0.5)";
app.modalConstants.family[152] = "Murloc 1.2 - CREATURE_FAMILY_MURLOC - 0.5 1.0 1.2(1.2) : 1/4_Mouvement_Contact_Prudent, 1/4_Mouvement_Contact_Avance_Recule, 2/4_Mouvement_Contact_Basique";
app.modalConstants.family[153] = "Naga 2.0 - CREATURE_FAMILY_NAGA - 0.5 1.0 2.0(2.0) : 1/3_Mouvement_Contact_Basique, 1/3_Mouvement_Contact_Tournant_Aleatoire, 1/3_Mouvement_Contact_Prudent_Volant";
app.modalConstants.family[155] = "CREATURE_FAMILY_SENTERRE uniquement si fixe - 0.25 1.0 0.4(1.5) : Mouvement_Contact_Basique ------   >>> SI PICKPOCKETLOOT <<< --- UPDATE `creature_template_addon` SET `auras` = '58984 164339' WHERE `creature_template_addon`.`entry` = XXXXX; ";
app.modalConstants.family[156] = "CREATURE_FAMILY_SE_DETERRE_AU_CONTACT - 0.5 0.9 0.5(1.5) : 1/3_Mouvement_Contact_Basique, 1/3_Mouvement_Contact_Tournant_Aleatoire, 1/3_Mouvement_Contact_Avance_Recule , Sans fumee : UPDATE `creature_template_addon` SET `auras` = '58984 164339' WHERE `creature_template_addon`.`entry` = xxxx;) ";
...
app.modalConstants.family[158] = "CREATURE_FAMILY_CREATURE_AQUATIQUE - 0.5  1.1 2.0(2.0) : 1/4_Mouvement_Contact_Prudent, 1/4_Mouvement_Contact_Prudent_Volant, 2/4_Mouvement_Contact_Basique";
...
app.modalConstants.family[161] = "CREATURE_FAMILY_SENTERRE_REMOU_CLAIR_CONTACT - 0.5 0.9 0.5 :  >>> SI PICKPOCKETLOOT <<< : UPDATE `creature_template_addon` SET `auras` = ''58984 164339 29147' WHERE `creature_template_addon`.`entry` = xxxx; ";
  ...
  app.modalConstants.faction[188]  = "Ambient (grenouille)";
...
app.modalConstants.faction[1850]    = "Les Traquesabres";
  ...
  app.modalConstants.type[5]  = "Geant - CREATURE_TYPE_GIANT - (0.8 1.2 1.0)";
  ...
  app.modalConstants.type[16] = "Elementaire Glissant - CREATURE_TYPE_ELEMENTAL_GLISSANT - (0.2 0.5 1.3)";
