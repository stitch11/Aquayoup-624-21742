...
LootItem::LootItem(LootStoreItem const& li)
{
	...
	// ITEM_FLAG_MULTI_DROP ==> ITEM_FLAG_PARTY_LOOT
...
bool LootItem::AllowedForPlayer(Player const* player) const
{
	...
	// ITEM_FLAG2_FACTION_HORDE ==> ITEM_FLAG2_HORDE_ONLY
	// ITEM_FLAG2_FACTION_ALLIANCE ==> ITEM_FLAG2_ALLIANCE_ONLY
	// ITEM_FLAG_HIDE_UNUSABLE_RECIPE ==> ITEM_FLAG_SMART_LOOT
	// BIND_ON_ACQUIRE ==> ITEM_FLAGS_CU_IGNORE_QUEST_STATUS
	// ITEM_FLAG_MULTI_DROP ==> ITEM_FLAG_PARTY_LOOT
