...
{
    BATTLEFIELD_WG_NPC_GUARD_H                      = 15000317,//30739,
    BATTLEFIELD_WG_NPC_GUARD_A                      = 15000318,//30740,
...
WintergraspObjectPositionData const WGKeepNPC[WG_MAX_KEEP_NPC] =
{
    ...
    { 5299.784180f, 2751.720459f, 409.192017f, 3.971740f, BATTLEFIELD_WG_NPC_VIERON_BLAZEFEATHER, BATTLEFIELD_WG_NPC_BOWYER_RANDOLPH }, // Vieron Blazefeather
    ...
    // North
    { 5368.327637f, 2801.840576f, 409.239105f, 2.600540f, BATTLEFIELD_WG_NPC_STONE_GUARD_MUKAR, BATTLEFIELD_WG_NPC_KNIGHT_DAMERON }, // Stone Guard Mukar
    { 5297.729004f, 2891.188232f, 409.192047f, 0.733038f, BATTLEFIELD_WG_NPC_HOODOO_MASTER_FU_JIN, BATTLEFIELD_WG_NPC_SORCERESS_KAYLANA }, // Voodoo Master Fu'jin
    { 5367.464844f, 2810.614014f, 409.239105f, 2.809980f, BATTLEFIELD_WG_NPC_CHAMPION_ROS_SLAI, BATTLEFIELD_WG_NPC_MARSHAL_MAGRUDER }, // Wintergrasp Quartermaster
    ...
    { 5294.162109f, 2930.772217f, 409.192566f, 0.872665f, BATTLEFIELD_WG_NPC_SIEGESMITH_STRONGHOOF, BATTLEFIELD_WG_NPC_SIEGE_MASTER_STOUTHANDLE }, // Stronghoof
    { 5383.023926f, 3014.849365f, 409.365662f, 3.250030f, BATTLEFIELD_WG_NPC_PRIMALIST_MULFORT, BATTLEFIELD_WG_NPC_ANCHORITE_TESSA }, // Primalist Mulfort
