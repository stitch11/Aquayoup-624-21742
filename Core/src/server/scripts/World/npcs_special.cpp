...
#define GOSSIP_PET1             "Comment puis-je entrainer mon familier ?"
#define GOSSIP_PET2             "Je souhaite de-entrainer mon familier "
#define GOSSIP_PET_CONFIRM      "Oui, faites s'il vous plait."
