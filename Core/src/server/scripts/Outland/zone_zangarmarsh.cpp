...
#define GOSSIP_ITEM_BLESS_ASH     "Accorde-moi ta benediction sage ancien"
#define GOSSIP_ITEM_BLESS_KEL     "Accorde-moi ta benediction puissant ancien"
        ...
        if (action == GOSSIP_ACTION_INFO_DEF+1)
        {
            ...
            if (creature->GetEntry() == NPC_ASHYEN)                //check which Creature we are dealing with
            {
                ...
                if (spell)
                {
					...
					player->ToPlayer()->KilledMonsterCredit(17900);
                }
            }
            ...
            if (creature->GetEntry() == NPC_KELETH)
            {
                ...
                {
                    creature->CastSpell(player, spell, true);
					player->ToPlayer()->KilledMonsterCredit(17901);
                }
            }
